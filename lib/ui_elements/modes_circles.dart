...
class ThreeCircles extends StatelessWidget {
  ...
  ThreeCircles({this.headline1,this.title1,this.function1,this.headline2, this.title2,this.function2, this.headline3, this.title3,this.function3});
    ...
    return Expanded(
      child: Column(
        children: [
          ...
          Expanded(child: ReusableCircle(headline: headline3, title: title3, function: function3)),
        ],
      ),
    );
  }
