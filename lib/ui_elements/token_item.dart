      ...
      child: ColoredCardBox(
        ...
        child: Row(
          ...
          children: [
            SizedBox(
              child: Container(
                  child: Text("${tokensList[widget.index].tokenType}",
                      style: text_style_table_row)),
              width: 125.0,
            ),
            SizedBox(
              child: Container(
                  child: Text("${tokensList[widget.index].lexeme}",
                      style: text_style_table_row)),
              width: 80.0,
            ),
            SizedBox(
              child: Container(
                  child: Text("${tokensList[widget.index].literal}",
                      style: text_style_table_row)),
              width: 80.0,
            ),
            SizedBox(
              child: Container(
                  child: Text("${tokensList[widget.index].line}",
                      style: text_style_table_row)),
              width: 80.0,
            ),
          ],
